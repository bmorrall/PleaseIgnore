  ...
  describe 'Validations' do
    ...
    describe 'permalink validations' do
      ...
      it 'should validate uniqueness of permalink' do
        create :organisation
        should validate_uniqueness_of(:permalink).case_insensitive
      end
    ...
    describe '#to_param' do
      it 'should equal permalink' do
        permalink = Faker::Lorem.word.downcase
        organisation = Organisation.new
        organisation.permalink = permalink
        expect(organisation.to_param).to eq permalink
      end
    end
  end
end
